class BalancesController < ApplicationController
  ...
  def index
    @balances = Balance.includes(:patient)
    @by_largest_outstanding_balance = @balances.debtors.order_by_balance_desc

    @by_oldes_unpaid = Balance.oldest_unpaid_balance
  end
  ...
  private
    ...
    def balance_params
      params.require(:balance).permit(:patient_id, :balance)
    end
end
